...
if (numNeighbours === 1){
    ...
    console.log('There is more than only 1 border');
}else{
    console.log('No borders');
}

//We should use the triple operator so this way it is restricted and avoid further errors or unexpected bugs and outputs.