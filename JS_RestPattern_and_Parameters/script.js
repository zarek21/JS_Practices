...
// 1.1 Destructure the keywords property (array) of the first book
// from the books array into variables called mainKeyword and rest.
// The first keyword should be assigned to mainKeyword, and
// the rest of the keywords should be assigned to the rest variable
// (it should be an array).
const [mainKeyword, ...rest] = books[0].keywords;
console.log(mainKeyword, rest);

// 1.2 Destructure the second book from the books array into a variable
// called bookPublisher. The bookPublisher variable should be assigned
// with the value of the publisher property of the book object.
// Assign the rest of the properties to the restOfTheBook variable.
const { publisher: bookPublisher, ...restOfTheBook } = books[1];
console.log(bookPublisher, restOfTheBook);

// 1.3 Write a function called printBookAuthorsCount that has
// two parameters called title and authors. The authors parameter
